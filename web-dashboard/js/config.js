...
const PM_CHART_COLORS = {
    pm1:         { border: '#f472b6', bg: 'rgba(244,114,182,0.08)' },
    pm25:        { border: '#22c55e', bg: 'rgba(34,197,94,0.08)' },
    outdoor:     { border: '#f59e0b', bg: 'rgba(245,158,11,0.08)' },
    pm10:        { border: '#6366f1', bg: 'rgba(99,102,241,0.08)' },
    outdoor_pm10:{ border: '#a855f7', bg: 'rgba(168,85,247,0.08)' },
};
...
const PM_TYPES = [
    ...
    { key: 'outdoor_pm10',label: '지역PM10',  unit: 'μg/m³' },
];
